    ...
    <footer id="contact" className="bg-navy-900 text-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-20">
        ...
        >
          ...
          <a
            href="tel:0522056000"
            aria-label={`${t('contact.phone')} — call us`}
          ...
          >
            <div className="w-12 h-12 rounded-full bg-amber-500/20 flex items-center justify-center mb-4" aria-hidden="true">
          ...
          <a
            ...
            aria-label={`${t('contact.whatsapp')} (opens in new tab)`}
            className="flex flex-col items-center text-center p-6 rounded-xl bg-white/5 hover:bg-white/10 transition-colors min-h-[44px]"
          >
            <div className="w-12 h-12 rounded-full bg-green-500/20 flex items-center justify-center mb-4" aria-hidden="true">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="text-green-400" aria-hidden="true" focusable="false">
